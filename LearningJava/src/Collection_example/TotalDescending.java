...
public class TotalDescending implements Comparator {	// 오름차순 외의 다른 정렬을 사용할수 있는 Comparator 인터페이스를 이용
	...
	public int compare(Object o1, Object o2) {		// 인스턴스 두개를 비교
		...
		if (o1 instanceof Student2 && o2 instanceof Student2) {		// o1,o2가 Student2에 속해있는지 확인
			...
			return ((s1.total < s2.total) ? 1 : (s1.total == s2.total) ? 0 : -1);		//(s1.total).compareTo(s2.total)*-1 ;
		}
